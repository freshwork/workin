...
:begin
call "%CXF_HOME%/bin/wsdl2java.bat" -p org.workin.test.ws.soap.service.image.large -d E:/works/Workin/workin-test/ http://localhost:8080/workin/soap/image/largeImageService?wsdl
