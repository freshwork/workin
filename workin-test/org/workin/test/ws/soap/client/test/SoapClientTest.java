...
public class SoapClientTest extends BaseTestCase {
	...
	public void startEngine() {
		...
		service = (EmployeeService)client.buildSoapService(URL_SOAP_SERVER);
		cxfService = (EmployeeService)client.buildSoapServiceWithCxf("EmployeeServiceImplService", URL_SOAP_SERVICES);
	}
